...
export class ExtractVlUserInfo1780000000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS idx_vl_user_info_xp_total ON vl_user_info (xp_total)`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS idx_vl_user_info_streak_days ON vl_user_info (streak_days)`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE users DROP COLUMN IF EXISTS avatar_emoji`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE users DROP COLUMN IF EXISTS active_persona_id`,
    );
    await queryRunner.query(
      `ALTER TABLE users DROP COLUMN IF EXISTS active_theme`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS avatar_emoji character varying(10) DEFAULT '🐣'`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS native_language character varying(10) DEFAULT 'en'`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS ui_language character varying(10) DEFAULT 'en'`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS current_level smallint DEFAULT 1`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS xp_total integer DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS streak_days smallint DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS last_active_date date`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS active_persona_id uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS active_theme character varying(20) DEFAULT 'apricot'`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS onboarding_done boolean DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS role character varying(20) DEFAULT 'user'`,
    );
    await queryRunner.query(
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS status character varying(20) DEFAULT 'active'`,
    );
    await queryRunner.query(
