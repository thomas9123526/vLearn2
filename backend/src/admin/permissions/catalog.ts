export type PermissionCategory = 'content' | 'prompts' | 'users' | 'analytics' | 'system' | 'admin';
...
export const PERMISSION_CATALOG: PermissionDef[] = [
  ...
  { key: 'categories.view',        category: 'content',  description: 'View scenario categories',                                         grantable_to_subadmin: true },
  { key: 'categories.edit',        category: 'content',  description: 'Create categories and edit their localized titles',                grantable_to_subadmin: true, implies: ['categories.view'] },
  { key: 'categories.delete',      category: 'content',  description: 'Delete categories (only when no scenarios reference them)',        grantable_to_subadmin: true, implies: ['categories.edit'] },
  ...
  { key: 'prompts.view',           category: 'prompts',  description: 'View AI prompt templates (tutor, grammar, feedback)',              grantable_to_subadmin: true },
  { key: 'prompts.edit',           category: 'prompts',  description: 'Edit AI prompt templates and toggle which are active',             grantable_to_subadmin: true, implies: ['prompts.view'] },
