...
#include "../qt_app/src/chat/ChatPage.h"
...
QT_MOC_LITERAL(1, 9, 13), // "statusMessage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "text"
QT_MOC_LITERAL(4, 29, 6) // "onSend"

    },
    "ChatPage\0statusMessage\0\0text\0onSend"
};
...
void ChatPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatPage::statusMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatPage::statusMessage(const QString & _t1)
{
