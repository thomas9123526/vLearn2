...
#include "../qt_app/src/chat/HistoryPage.h"
...
QT_MOC_LITERAL(1, 12, 13), // "openRequested"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 9) // "sessionId"

    },
    "HistoryPage\0openRequested\0\0sessionId"
};
...
void HistoryPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->openRequested((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HistoryPage::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryPage::openRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HistoryPage::openRequested(const QString & _t1)
{
