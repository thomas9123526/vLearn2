...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get signInRememberMe => '계정 저장';
  ...
  @override
  String get accountSuspendedBody => '오류라고 생각되시면 고객 지원에 문의해 주세요.';

  @override
  String get homeGreetingMorning => '좋은 아침이에요';

  @override
  String get homeGreetingAfternoon => '좋은 오후에요';

  @override
  String get homeGreetingEvening => '좋은 저녁이에요';
  ...
  @override
  String get conversationInputHint => '메시지를 입력하세요…';

  @override
  String get conversationGreatWork => '잘하셨어요!';

  @override
  String conversationSummary(int words, int turns) {
    return '$turns번의 대화에서 $words개의 단어를 말했습니다.';
  }
  ...
  String settingsCompressionHint(int thresholdKb) {
    return '${thresholdKb}KB보다 큰 서버 응답을 압축하여 대역폭을 절약합니다.';
  }
  ...
  @override
  String get settingsFontGroup => '폰트 그룹';
  ...
  @override
  String get conversationModeFaceHint => '애니메이션 튜터와 대화합니다. 튜터가 말로 답합니다.';

  @override
  String get conversationModeChat => '채팅 모드';

  @override
  String get conversationModeChatHint => '튜터와 텍스트로 대화합니다.';
  ...
  @override
  String get newsEmpty => '뉴스가 없습니다.';

  @override
  String get newsMarkAllRead => '모두 읽음으로 표시';

  @override
  String get newsUnreadBadge => '읽지 않음';
  ...
  @override
  String get guardBlockedTitle => '전송할 수 없습니다';

  @override
  String get guardBlockedBody => '대화를 예의 바르게 유지합시다. 메시지를 다시 표현해 보세요.';

  @override
  String get guardWarnTitle => '언어에 주의하세요';

  @override
  String get guardWarnBody => '메시지에 강한 표현이 포함되어 있습니다. 그래도 보내시겠습니까?';

  @override
  String get guardWarnContinue => '계속하기';
}
