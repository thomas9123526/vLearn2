# # Update Config Skill Modify Claude Code configuration by updating settings.json

Session: `1eb40659-e5c9-4cd9-aa44-b57f47d3b5f7`
Saved: 2026-05-28T02:12:50.139Z
...
Set ANDROID_HOME=E:\vm_share\Sdk and GRADLE_USER_HOME=E:\vm_share\.gradle in environment variables
...
Done. Both env vars are now set in your global Claude Code settings:

- `ANDROID_HOME` → `E:\vm_share\Sdk`
- `GRADLE_USER_HOME` → `E:\vm_share\.gradle`

These apply to every Claude Code session going forward. Now run `flutter doctor` to confirm Flutter picks up the new SDK location.
